...
const testimonials = [
  ...
  },
  {
    type: "text",
    quote:
      "Collaborating with this incredible team has completely revolutionized our approach. Their deep expertise and unwavering commitment not only enhanced our operations but also boosted our overall success!",
    name: "Seema Gopal",
    company: "Mint Tree",
  },
];
                ...
                {t.type === "image" && (
                  <div className="relative w-full h-72">
                    ...
                    <div className="absolute inset-0 bg-black/40 flex flex-col justify-end p-4">
                      <p className="text-white font-medium mb-2">"{t.quote}"</p>
