            ...
            <div className="container mx-auto px-6 md:px-8">
                <div className="mb-8 flex items-end justify-between md:mb-14 lg:mb-16">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="max-w-lg text-muted-foreground text-gray-300">{description}</p>
                    </div>
                    <div className="hidden shrink-0 gap-2 md:flex">
                        <Button
                            ...
                            className="disabled:pointer-events-auto text-white hover:bg-white/10 hover:text-white"
                        >
                            ...
                            >
                                <a href={item.href} className="group rounded-xl block h-full">
                                    <div className="group relative h-full min-h-[27rem] max-w-full overflow-hidden rounded-xl md:aspect-[5/4] lg:aspect-[16/9]">
                                        ...
                                        />
                                        <div className="absolute inset-0 h-full bg-gradient-to-t from-black via-black/70 to-black/30" />
